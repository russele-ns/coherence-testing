...
namespace Coherence.Generated
{
    ...
    [UnityEngine.Scripting.Preserve, System.Serializable]
    public class Binding_5adef152083604ef289a125a77765def_b4b71b16fe0243b6a72b92263f5b7dd8 : PositionBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    public class CoherenceSync_5adef152083604ef289a125a77765def : CoherenceSyncBaked
    {
        ...
        private readonly Dictionary<string, Binding> bakedValueBindings = new Dictionary<string, Binding>()
        {
			...
			["b4b71b16fe0243b6a72b92263f5b7dd8"] = new Binding_5adef152083604ef289a125a77765def_b4b71b16fe0243b6a72b92263f5b7dd8(),
        };
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_5adef152083604ef289a125a77765def Unhandled command: {command.GetType()}.");
                    break;
            }
        }

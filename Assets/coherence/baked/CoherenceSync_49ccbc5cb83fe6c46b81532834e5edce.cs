...
namespace Coherence.Generated
{
    ...
    public class CoherenceSync_49ccbc5cb83fe6c46b81532834e5edce : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_49ccbc5cb83fe6c46b81532834e5edce>();
        ...
        public CoherenceSync_49ccbc5cb83fe6c46b81532834e5edce()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_49ccbc5cb83fe6c46b81532834e5edce Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_49ccbc5cb83fe6c46b81532834e5edce>();
            this.bridge = bridge;

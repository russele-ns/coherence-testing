...
namespace Coherence.Generated
{
    ...
    public class Binding_0ad1a2a127f83c14885e13cddb0ff433_6b49eaba1d074ef6b3fd7c030b7236db : PositionBinding
    {   
    ...
    public class CoherenceSync_0ad1a2a127f83c14885e13cddb0ff433 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_0ad1a2a127f83c14885e13cddb0ff433>();
        ...
        {
			["6b49eaba1d074ef6b3fd7c030b7236db"] = new Binding_0ad1a2a127f83c14885e13cddb0ff433_6b49eaba1d074ef6b3fd7c030b7236db(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_0ad1a2a127f83c14885e13cddb0ff433()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_0ad1a2a127f83c14885e13cddb0ff433 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_0ad1a2a127f83c14885e13cddb0ff433>();
            this.bridge = bridge;

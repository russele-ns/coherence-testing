...
namespace Coherence.MatchmakingDialogSample.UI
{
    ...
    {
        public event Action<IEnumerable<string>> SelectedRegionsChanged
        {
            add => regionsInput.SelectedRegionsChanged += value;
            remove => regionsInput.SelectedRegionsChanged -= value;
        }

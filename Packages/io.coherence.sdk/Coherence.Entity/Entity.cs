...
namespace Coherence.Entities
{
    ...
    public struct Entity : IComparable<Entity>, IEquatable<Entity>
    {
        ...
        /// </summary>
        public const Index MaxRelativeIndex = (Index)ushort.MaxValue;

        /// <summary>
        /// EndOfEntities used to mark the serialized end of entities.
        /// </summary>
        public const Index EndOfEntities = MaxRelativeIndex;

        /// <summary>
        /// MaxRelativeIndices is the maximum number of usable indicies.
        /// </summary>
        public const Index MaxRelativeIndices = MaxRelativeIndex - 2; //0 and MaxIndex are reserved

        /// <summary>
        /// MaxID is the highest useable ID.
        /// </summary>
        public const Index MaxRelativeID = MaxRelativeIndex - 1;

        /// <summary>
        /// ClientInitialIndex .
        /// </summary>
        public const Index ClientInitialIndex = (Index)((int)MaxRelativeIndex >> 1) + 1; // 32,768
        ...
        public Entity(Index index, byte version, bool isAbsolute)
        {
            Index = index;
            Version = version;

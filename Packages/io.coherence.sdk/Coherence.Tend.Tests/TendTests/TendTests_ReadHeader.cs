namespace Coherence.Tend.Tests
{
    ...
    public partial class TendTests
    {
        ...
        public void DoesntAcceptRemoteSeqOutOfRange(byte remoteIdGap, bool expectReadOk)
        {
            ...
            // Act & Assert
            var readOK = tend.ReadHeader(SerializeHeader(1, remoteIdGap, 0b1), out var _, out var _);
            Assert.AreEqual(expectReadOk, readOK);
        }
        ...
        public void ReadHeader_WhenPacketTooSmall()
        {
            ...
            // make the first bit (left most) indicate this is reliable so
            // we try to get the rest of the bits and error out because of too few bytes.

...
namespace Coherence.Editor.Tests
{
    ...
    public class EndpointsTests : CoherenceTest
    {
        ...
        public void Portal_Contains_Standard_Url()
        {
            ...
            Assert.That(Endpoints.OnlineDashboard, Is.EqualTo($"https://{Endpoints.apiDomain}/{Endpoints.apiVersion}/portal"));
        }
        ...
        public void Portal_Contains_Supplied_CustomDomain_Url()
        {
            ...
            Assert.That(Endpoints.OnlineDashboard,
        ...
        public void Get_Returns_Correct_Url_ForPath(string path)
        {
            ...
            var actualPath = Endpoints.Get(Endpoints.OnlineDashboard + path);
        ...
        public void TryGet_Returns_Correct_Url_ForPath(string path)
        {
            ...
            var result = Endpoints.TryGet(Endpoints.OnlineDashboard + path, orgId, projectId,  out var actualPath, out _);
        ...
        {
            ProjectSettings.instance.UseCustomEndpoints = false;
            var result = Endpoints.TryGet(Endpoints.OnlineDashboard + path, orgId, projectId,  out _, out _);

...
namespace Coherence.CodeGen
{
    ...
    public class SchemaCommandsBaker : IBaker
    {
        public BakeResult Bake(CodeGenData codeGenData)
        {
            ...
            scribanOptions.Model[0]["commands"] = bakedCommands;

            var renderResult =
                scribanWriter.Render(scribanOptions, System.IO.Path.Combine(codeGenData.OutputDirectory, "Interop"), "baked_commands");

...
namespace Coherence.Runtime
{
    ...
    public sealed class WebSocketManager : IUpdatable, IDisposableInternal
    {
        ...
        private string ClientVersion => "unity-sdk-v" + runtimeSettings.SdkVersion;
...
#pragma warning restore CS0414
        ...
        private string GetFinalWsEndpoint(string requestID) =>
            $"{Endpoint}&client={ClientVersion}&engine={runtimeSettings.RsVersion}&schema_id={runtimeSettings.SchemaID}&req_id={requestID}";

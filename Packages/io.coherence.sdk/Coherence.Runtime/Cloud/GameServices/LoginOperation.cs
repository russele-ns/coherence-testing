...
namespace Coherence.Cloud
{
    ...
    public sealed class LoginOperation : CloudOperation<PlayerAccount, LoginOperationError>
    {
        ...
        /// Reference to a function to execute if and when the operation has completed successfully.
        /// </param>
        public LoginOperation OnSuccess([DisallowNull] Action<LoginOperation> action)
        {
            ...
            task.ContinueWith(_ => action(this), TaskContinuationOptions.OnlyOnRanToCompletion);
            return this;
        }
        ...
        /// Reference to a function to execute if and when the operation has completed successfully.
        /// </param>
        public new LoginOperation OnSuccess([DisallowNull] Action action)
        {
            base.OnSuccess(action);
            return this;
        }

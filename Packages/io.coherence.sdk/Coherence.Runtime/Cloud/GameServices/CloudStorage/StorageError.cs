...
namespace Coherence.Cloud
{
    ...
    public sealed class StorageError : CoherenceError<StorageErrorType>
    {
        ...
        private static string GetMessage(RequestException requestException, StorageObjectId[] storageObjectIds) => requestException.HttpStatusCode switch
        {
            ...
            HttpStatusCode.Forbidden => "You do not have permission to perform this operation. Please check that you have enabled the 'Persisted Player Accounts' service in the Project Setting section of the Online Dashboard at https://coherence.io/dashboard.\n" + requestException,

...
namespace Coherence.Cloud
{
    ...
    public struct CloudUniqueId : IFormattable, IEquatable<CloudUniqueId>
    {
        ...
        /// <summary>
        /// Gets the number of characters in the <see cref="CloudUniqueId"/>.
        /// </summary>
        public int Length => value?.Length ?? 0;

        /// <summary>
        /// Initializes a new instance of the <see cref="CloudUniqueId"/> struct.
        /// </summary>
        /// <param name="id"> The string representation of the <see cref="CloudUniqueId"/>. </param>
        public CloudUniqueId(string id) => value = id ?? "";

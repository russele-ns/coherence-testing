...
namespace Coherence.Cloud
{
    ...
    internal sealed class NewPlayerAccountProvider : IPlayerAccountProvider
    {
        ...
        private readonly List<Created> createdPlayerAccounts = new(1);
        ...
        public PlayerAccount GetPlayerAccount(LoginInfo loginInfo)
        {
            ...
            createdPlayerAccounts.Add(new(this, newPlayerAccount));
        ...
        public void Dispose()
        {
            ...
            var playerAccountsToDispose = createdPlayerAccounts.ToArray();
            createdPlayerAccounts.Clear();
            foreach (var playerAccount in playerAccountsToDispose)
            {
                playerAccount.Dispose();
            }
        }

        private sealed class Created : IDisposable
        {
            private readonly NewPlayerAccountProvider provider;
            private readonly PlayerAccount account;

            public Created(NewPlayerAccountProvider provider, PlayerAccount account)
            {
                this.provider = provider;
                this.account = account;
                account.OnDisposed += OnDisposed;
            }
            ...
            private void OnDisposed() => provider.createdPlayerAccounts.Remove(this);
        }
    }
}

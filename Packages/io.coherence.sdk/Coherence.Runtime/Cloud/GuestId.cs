...
namespace Coherence.Cloud
{
    ...
    public readonly struct GuestId : IEquatable<GuestId>
    {
        ...
        /// <summary>
        /// Gets the number of characters in the <see cref="GuestId"/>.
        /// </summary>
        public int Length => id?.Length ?? 0;

        /// <summary>
        /// Initializes a new instance of the <see cref="GuestId"/> struct.
        /// </summary>
        /// <param name="id"> The string representation of the guest id. </param>
        public GuestId(string? id) => this.id = id;
        ...
        private static string GetPrefsKey(string projectId, CloudUniqueId uniqueId)
        {
            var processId = ProcessId.Get();
            return processId is ProcessId.FirstProcessId ? PrefsKeys.CachedGuestId.Format(projectId, uniqueId) : PrefsKeys.CachedGuestIdWithProcessId.Format(projectId, uniqueId, processId);
        }

...
namespace Coherence.Runtime
{
    internal static class PrefsKeys
    {
        ...
        /// <summary>
        /// Prefs key used to store the id of a guest that has logged in to a particular project using a particular Unique Id,
        /// in cases where more than one instances of the application are running concurrently on the same machine.
        /// </summary>
        public const string CachedGuestIdWithProcessId = "Coherence.Proj{0}.Id{1}.Nth{2}.GuestId";
        ...
        /// <summary>
        /// Prefs key used to store the <see cref="Coherence.Prefs.ProcessId"/> of the current process.
        /// </summary>
        public const string ProcessId = "Coherence.Proj{0}.ProcessId{1}";
    }

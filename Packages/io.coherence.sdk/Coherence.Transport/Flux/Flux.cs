...
namespace Coherence.Flux
{
    ...
    public class Flux
    {
        ...
        public void Open(string hostAndPort, ushort maxBufferSize)
        {
            port.Open(ReportDataReceived, maxBufferSize, this);
        ...
        public void Listen(EndpointData endpoint, ushort maxBufferSize)
        {
            port.Listen(GetEndpoint(endpoint), ReportDataReceived, maxBufferSize, this);
        ...
        public void SendPacketTo(ArraySegment<byte> packet, IPEndPoint endpoint)
        {
            ...
            _ = BitConverter.TryWriteBytes(packetSpan[..roomByteCount], roomId);

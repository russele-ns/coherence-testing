...
namespace Coherence.Runtime.Tests
{
    ...
    /// </para>
    /// <para>
    /// <see cref="Coherence.Cloud.PlayerAccount.Services"/> are faked using <see cref="CloudServiceBuilder"/>.
    /// </para>
    /// </summary>
    internal sealed class FakePlayerAccountBuilder : IDisposable
    {
        ...
        public PlayerAccount Build()
        {
            ...
            buildExecuted = true;
            CloudServiceBuilder.AuthClientBuilder.SetPlayerAccount(() => playerAccount);

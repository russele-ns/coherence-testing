...
namespace Coherence.Toolkit
{
    ...
    public sealed class CoherenceSyncConfig : ScriptableObject
    {
        ...
        private LazyLogger logger = Log.GetLazyLogger<CoherenceSyncConfig>();
        ...
        {
            public const string objectInstantiator = nameof(CoherenceSyncConfig.objectInstantiator);
            public const string includeInSchema = nameof(CoherenceSyncConfig.includeInSchema);
            public const string id = nameof(CoherenceSyncConfig.id);
            public const string selfId = nameof(CoherenceSyncConfig.selfId);
            public const string editorTarget = nameof(CoherenceSyncConfig.editorTarget);
        }
#endif
    }
}

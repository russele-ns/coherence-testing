...
namespace Coherence.Toolkit
{
    ...
    public static class ScriptExecutionOrder
    {
        ...
        /// </summary>
        public const int CoherenceCloudLogin = -2200;
        /// <summary>
        /// <see cref="Coherence.Toolkit.CoherenceBridge"/>
        /// </summary>
        public const int CoherenceBridge = -2100;
        /// <summary>
        /// <see cref="Coherence.Toolkit.CoherenceScene"/>
        /// </summary>
        public const int CoherenceScene = -2000;
        /// <summary>

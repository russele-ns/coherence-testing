namespace Coherence.Toolkit.Bindings.ValueBindings
{
    ...
    public class Vector2Binding : ValueBinding<Vector2>
    {
        ...
        public void ToggleInterpolationDebugGrapherForX() => ToggleInterpolationDebugGrapher(v2 => v2.x, "X");

        [InterpolationDebugContextItem("Y")]
        public void ToggleInterpolationDebugGrapherForY() => ToggleInterpolationDebugGrapher(v2 => v2.y, "Y");

        [InterpolationDebugContextItem("magnitude")]
        public void ToggleInterpolationDebugGrapherForMagnitude() => ToggleInterpolationDebugGrapher(v2 => v2.magnitude, "magnitude");
    }
}

namespace Coherence.Toolkit.Bindings.ValueBindings
{
    ...
    public class ColorBinding : ValueBinding<Color>
    {
        ...
        [InterpolationDebugContextItem("R")]
        public void ToggleInterpolationDebugGrapherForR() => ToggleInterpolationDebugGrapher(c => c.r, "R");

        [InterpolationDebugContextItem("G")]
        public void ToggleInterpolationDebugGrapherForG() => ToggleInterpolationDebugGrapher(c => c.g, "G");

        [InterpolationDebugContextItem("B")]
        public void ToggleInterpolationDebugGrapherForB() => ToggleInterpolationDebugGrapher(c => c.b, "B");

        [InterpolationDebugContextItem("A")]
        public void ToggleInterpolationDebugGrapherForA() => ToggleInterpolationDebugGrapher(c => c.a, "A");
    }
}

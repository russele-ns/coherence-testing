namespace Coherence.Toolkit.Bindings.ValueBindings
{
    ...
    public class Vector3Binding : ValueBinding<Vector3>
    {
        ...
        [InterpolationDebugContextItem("X")]
        public void ToggleInterpolationDebugGrapherForX() => ToggleInterpolationDebugGrapher(v3 => v3.x, "X");

        [InterpolationDebugContextItem("Y")]
        public void ToggleInterpolationDebugGrapherForY() => ToggleInterpolationDebugGrapher(v3 => v3.y, "Y");

        [InterpolationDebugContextItem("Z")]
        public void ToggleInterpolationDebugGrapherForZ() => ToggleInterpolationDebugGrapher(v3 => v3.z, "Z");

        [InterpolationDebugContextItem("magnitude")]
        public void ToggleInterpolationDebugGrapherForMagnitude() => ToggleInterpolationDebugGrapher(v3 => v3.magnitude, "magnitude");
    }
}

namespace Coherence.Toolkit
{
    ...
    public interface ICoherenceSyncUpdater
    {
        ...
        void SyncAndSend(double time, AbsoluteSimulationFrame simulationFrame);

        void SampleBindings(double time);
        void SampleAllBindings(double time);

        void GetComponentUpdates(List<ICoherenceComponentData> updates, double currentTime, AbsoluteSimulationFrame simulationFrame, bool forceSerialize = false);

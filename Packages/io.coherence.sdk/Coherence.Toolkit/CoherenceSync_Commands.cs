...
namespace Coherence.Toolkit
{
    ...
    public partial class CoherenceSync
    {
        ...
        public bool SendCommand<TTarget>(string methodName, MessageTarget target) where TTarget : class
        {
        ...
        public bool SendCommand<TTarget>(string methodName, MessageTarget target, params object[] args) where TTarget : class
        {
        ...
        /// </param>
        public bool SendCommand<TTarget>(string methodName, MessageTarget target, params ValueTuple<Type, object>[] args) where TTarget : class
        {
            return SendCommand(typeof(TTarget), methodName, target, args);
        }
        ...
        /// </summary>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget)"/>
        public bool SendCommandToChildren<TTarget>(string methodName, MessageTarget target) where TTarget : class
        {
        ...
        /// <inheritdoc cref="SendCommandToChildren{TTarget}(string, MessageTarget)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, object[])"/>
        public bool SendCommandToChildren<TTarget>(string methodName, MessageTarget target, params object[] args) where TTarget : class
        {
        ...
        /// <inheritdoc cref="SendCommandToChildren{TTarget}(string, MessageTarget)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, ValueTuple{Type, object}[])"/>
        public bool SendCommandToChildren<TTarget>(string methodName, MessageTarget target, params ValueTuple<Type, object>[] args) where TTarget : class
        {
            return SendCommandToChildren(typeof(TTarget), methodName, target, args);
        }
        ...
        /// </summary>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget)"/>
        public bool SendOrderedCommand<TTarget>(string methodName, MessageTarget target) where TTarget : class
        {
        ...
        /// <inheritdoc cref="SendOrderedCommand{TTarget}(string, MessageTarget)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, object[])"/>
        public bool SendOrderedCommand<TTarget>(string methodName, MessageTarget target, params object[] args) where TTarget : class
        {
        ...
        /// <inheritdoc cref="SendOrderedCommand{TTarget}(string, MessageTarget)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, ValueTuple{Type, object}[])"/>
        public bool SendOrderedCommand<TTarget>(string methodName, MessageTarget target, params ValueTuple<Type, object>[] args) where TTarget : class
        {
            return SendOrderedCommand(typeof(TTarget), methodName, target, args);
        }
        ...
        /// </summary>
        /// <inheritdoc cref="SendCommand(Type, string, MessageTarget)"/>
        public bool SendOrderedCommandToChildren<TTarget>(string methodName, MessageTarget target) where TTarget : class
        {
        ...
        /// <inheritdoc cref="SendOrderedCommandToChildren{TTarget}(string, MessageTarget)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, object[])"/>
        public bool SendOrderedCommandToChildren<TTarget>(string methodName, MessageTarget target, params object[] args) where TTarget : class
        {
        ...
        /// <inheritdoc cref="SendOrderedCommandToChildren{TTarget}(string, MessageTarget)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, ValueTuple{Type, object}[])"/>
        public bool SendOrderedCommandToChildren<TTarget>(string methodName, MessageTarget target, params ValueTuple<Type, object>[] args) where TTarget : class
        {
            return SendOrderedCommandToChildren(typeof(TTarget), methodName, target, args);
        }
        ...
        /// </summary>
        /// <param name="channel">The channel over which the command is sent.</param>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget)"/>
        public bool SendCommandOverChannel<TTarget>(string methodName, MessageTarget target, Channel channel) where TTarget : class
        {
            return commandsHandler.SendCommand(typeof(TTarget), methodName, target, channel, false, Array.Empty<object>());
        }

        /// <inheritdoc cref="SendCommandOverChannel{TTarget}(string, MessageTarget, Channel)" path="/summary"/>
        /// <inheritdoc cref="SendCommand(Type, string, MessageTarget)"/>
        public bool SendCommandOverChannel(Type targetType, string methodName, MessageTarget target, Channel channel)
        {
            return commandsHandler.SendCommand(targetType, methodName, target, channel, false, Array.Empty<object>());
        }
        ...
        {
            return SendCommandOverChannel(typeof(TTarget), methodName, target, channel, args);
        }
        ...
        {
            return commandsHandler.SendCommand(targetType, methodName, target, channel, false, args);
        }

        /// <inheritdoc cref="SendCommandOverChannel{TTarget}(string, MessageTarget, Channel)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, ValueTuple{Type, object}[])"/>
        public bool SendCommandOverChannel<TTarget>(string methodName, MessageTarget target, Channel channel, params ValueTuple<Type, object>[] args) where TTarget : class
        {
            return SendCommandOverChannel(typeof(TTarget), methodName, target, channel, args);
        }
        ...
        /// <inheritdoc cref="SendCommandOverChannel{TTarget}(string, MessageTarget, Channel)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, ValueTuple{Type, object}[])"/>
        public bool SendCommandOverChannel(Type targetType, string methodName, MessageTarget target, Channel channel, params ValueTuple<Type, object>[] args)
        {
            return commandsHandler.SendCommand(targetType, methodName, target, channel, false, args);
        }
        ...
        {
            return SendCommandToChildrenOverChannel(typeof(TTarget), methodName, target, channel, Array.Empty<object>());
        }

        /// <inheritdoc cref="SendCommandToChildrenOverChannel{TTarget}(string, MessageTarget, Channel)" path="/summary"/>
        /// <inheritdoc cref="SendCommand(Type, string, MessageTarget)"/>
        public bool SendCommandToChildrenOverChannel(Type targetType, string methodName, MessageTarget target, Channel channel)
        {
            return commandsHandler.SendCommand(targetType, methodName, target, channel, true, Array.Empty<object>());
        }
        ...
        {
            return SendCommandToChildrenOverChannel(typeof(TTarget), methodName, target, channel, args);
        }
        ...
        {
            return commandsHandler.SendCommand(targetType, methodName, target, channel, true, args);
        }

        /// <inheritdoc cref="SendCommandToChildrenOverChannel{TTarget}(string, MessageTarget, Channel)" path="/summary"/>
        /// <inheritdoc cref="SendCommand{TTarget}(string, MessageTarget, ValueTuple{Type, object}[])"/>
        public bool SendCommandToChildrenOverChannel<TTarget>(string methodName, MessageTarget target, Channel channel, params ValueTuple<Type, object>[] args) where TTarget : class
        {
            return SendCommandToChildrenOverChannel(typeof(TTarget), methodName, target, channel, args);
        }
        ...
        /// <inheritdoc cref="SendCommandToChildrenOverChannel{TTarget}(string, MessageTarget, Channel)" path="/summary"/>
        /// <inheritdoc cref="SendCommand(Type, string, MessageTarget, ValueTuple{Type, object}[])"/>
        public bool SendCommandToChildrenOverChannel(Type targetType, string methodName, MessageTarget target, Channel channel, params ValueTuple<Type, object>[] args)
        {
            return commandsHandler.SendCommand(targetType, methodName, target, channel, true, args);
        }

        /// <summary>
        ///     Send a command over a specified channel to another client to call a method in a specific component,
        ///     if you have more than one component method bound in the same hierarchy.
        /// </summary>
        /// <param name="channel">The channel over which the command is sent.</param>
        /// <inheritdoc cref="SendCommand(Action, MessageTarget)"/>
        public bool SendCommandOverChannel(Action action, MessageTarget target, Channel channel)
        {
            return commandsHandler.SendCommand(action, target, channel);
        }

        /// <inheritdoc cref="SendCommandOverChannel(Action, MessageTarget, Channel)"/>
        /// <param name="param1">Argument of type T1 to send to the method</param>
        public bool SendCommandOverChannel<T1>(Action<T1> action, MessageTarget target, Channel channel, T1 param1)
        {
            ...
            return commandsHandler.SendCommand(action, target, channel, args);
        }

        /// <inheritdoc cref="SendCommandOverChannel{T1}(Action{T1}, MessageTarget, Channel, T1)"/>
        /// <param name="param2">Argument of type T2 to send to the method</param>
        ...
        /// <inheritdoc cref="SendCommandOverChannel{T1, T2}(Action{T1, T2}, MessageTarget, Channel, T1, T2)"/>
        /// <param name="param3">Argument of type T3 to send to the method</param>
        ...
        /// <inheritdoc cref="SendCommandOverChannel{T1, T2, T3}(Action{T1, T2, T3}, MessageTarget, Channel, T1, T2, T3)"/>
        /// <param name="param4">Argument of type T4 to send to the method</param>
        ...
        /// <inheritdoc cref="SendCommandOverChannel{T1, T2, T3, T4}(Action{T1, T2, T3, T4}, MessageTarget, Channel, T1, T2, T3, T4)"/>
        /// <param name="param5">Argument of type T5 to send to the method</param>
        ...
        /// <inheritdoc cref="SendCommandOverChannel{T1, T2, T3, T4, T5}(Action{T1, T2, T3, T4, T5}, MessageTarget, Channel, T1, T2, T3, T4, T5)"/>
        /// <param name="param6">Argument of type T6 to send to the method</param>
        ...
        /// <inheritdoc cref="SendCommandOverChannel{T1, T2, T3, T4, T5, T6}(Action{T1, T2, T3, T4, T5, T6}, MessageTarget, Channel, T1, T2, T3, T4, T5, T6)"/>
        /// <param name="param7">Argument of type T7 to send to the method</param>
        ...
        /// <inheritdoc cref="SendCommandOverChannel{T1, T2, T3, T4, T5, T6, T7}(Action{T1, T2, T3, T4, T5, T6, T7}, MessageTarget, Channel, T1, T2, T3, T4, T5, T6, T7)"/>
        /// <param name="param8">Argument of type T8 to send to the method</param>

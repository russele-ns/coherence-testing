...
namespace Coherence.Core.Tests
{
    ...
    public class ReceiveSequenceBufferTests : CoherenceTest
    {
        private struct TestCommand : IEntityMessage
        {
            ...
            {
                Entity = new Entity((Index)1, 0, false);
            ...
            public IEntityMapper.Error MapToAbsolute(IEntityMapper mapper, Log.Logger logger) => IEntityMapper.Error.EntityNotFound;
            public IEntityMapper.Error MapToRelative(IEntityMapper mapper, Log.Logger logger) => IEntityMapper.Error.EntityNotFound;

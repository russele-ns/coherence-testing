...
namespace Coherence.Core.Tests
{
    ...
    public class RefsResolverTests : CoherenceTest
    {
        ...
        private Dictionary<Entity, AuthorityType> authorityByEntity;
        ...
        public override void SetUp()
        {
            ...
            authorityByEntity = new Dictionary<Entity, AuthorityType>();
            entityRegistry = new EntityRegistry(knownEntities, authorityByEntity);
        }

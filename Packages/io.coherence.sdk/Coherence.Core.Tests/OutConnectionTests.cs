...
namespace Coherence.Core.Tests
{
    ...
    public class OutConnectionTests : CoherenceTest
    {
        ...
        public void Update_WhenChannelHasChange_ShouldSendAPacket()
        {
            ...
            _ = channelMock.Setup(c => c.Serialize(It.IsAny<SerializerContext<IOutBitStream>>(), simulationFrame, floatingOrigin, false, ackedEntities)).Returns(true);
        ...
        public void Test_HoldCommandsForEntityThrowsErrorsWhenEntityUpdated()
        {
            ...
            // Act
            outConnection.UpdateEntity(entityA, entityAComponents, ChannelID.Default);
        ...
        public void Test_HoldCommandsForEntityThrowsErrorsWhenEntityComponentRemoved()
        {
            ...
            // Act
            outConnection.RemoveComponent(entityA, new uint[] { 42 }, ChannelID.Default);
        ...
        public void Test_SentAndAckedChangesClearHeldEntities()
        {
            ...
            channelMock.Setup(c => c.Serialize(It.IsAny<SerializerContext<IOutBitStream>>(), simulationFrame, Vector3d.zero, true, ackedEntities)).Returns(true).Verifiable();
            _ = channelMock.Setup(c => c.HasChanges(It.IsAny<IReadOnlyCollection<Entity>>())).Returns(true);
        ...
        public void Test_AddChannel_MustBeValid()
        {
            ...
            Assert.DoesNotThrow(() => AddChannel((ChannelID)3));
        ...
        private Mock<IOutNetworkChannel> CreateChannel()
        {
            ...
            _ = channel.Setup(c => c.Serialize(It.IsAny<SerializerContext<IOutBitStream>>(), It.IsAny<AbsoluteSimulationFrame>(),
                It.IsAny<Vector3d>(), It.IsAny<bool>(), It.IsAny<IReadOnlyCollection<Entity>>()));

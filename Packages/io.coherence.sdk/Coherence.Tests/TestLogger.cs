...
namespace Coherence.Common.Tests
{
    ...
    public class TestLogger : Logger
    {
        ...
        private TestLogger(Type source,
            ...
            List<ILogTarget> baseLogTargets,
            List<ILogTarget> customLogTargets) :
        ...
        {
            var newLogger = new TestLogger(source, logLevels, logWarnings, logErrors, baseLogTargets, customLogTargets)
            {
                WithLogger = this,
                Context = Context,

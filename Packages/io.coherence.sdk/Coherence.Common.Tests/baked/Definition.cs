...
namespace Coherence.Generated
{
    ...
    {
        public const string schemaId = "6e8b0e69f936b2ba8d5ae0ac901e7929ca5a777a";
        ...
        public const uint InternalEntityRefsCommand = 10;
        public const uint InternalByteArraysCommand = 11;
        ...
        public const uint InternalByteArraysInput = 9;
        ...
        public static readonly Dictionary<uint, MessageTarget> CommandRoutingByType = new Dictionary<uint, MessageTarget>()
        {
            ...
            { Definition.InternalByteArraysCommand , MessageTarget.All },
        };
        ...
        public IEntityCommand ReadCommand(uint commandType, Entity entity, MessageTarget target, IInProtocolBitStream bitStream, Logger logger)
        {
            switch (commandType)
            {
                ...
                case Definition.InternalByteArraysCommand:
                    return ByteArraysCommand.Deserialize(bitStream, entity, target);
                default:
        ...
        public IEntityInput ReadInput(uint inputType, Entity entity, long frame, IInProtocolBitStream bitStream, Logger logger)
        {
            switch (inputType)
            {
                ...
                case Definition.InternalByteArraysInput:
                    return ByteArraysInput.Deserialize(bitStream, entity, frame);
                default:
        ...
        public void WriteCommand(IEntityCommand data, uint commandType, IOutProtocolBitStream bitStream, Logger logger)
        {
            switch (commandType)
            {
                ...
                case Definition.InternalEntityRefsCommand:
                    ...
                    break;
                case Definition.InternalByteArraysCommand:
                    ByteArraysCommand.Serialize((ByteArraysCommand)data, bitStream);
                    break;
                default:
        ...
        public void WriteInput(IEntityInput data, uint inputType, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            switch (inputType)
            {
                ...
                case Definition.InternalCompressedInput:
                    ...
                    break;
                case Definition.InternalByteArraysInput:
                    ByteArraysInput.Serialize((ByteArraysInput)inputData.Input, bitStream);
                    break;
                default:

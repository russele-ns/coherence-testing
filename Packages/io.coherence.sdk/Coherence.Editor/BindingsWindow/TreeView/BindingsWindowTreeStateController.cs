...
namespace Coherence.Editor
{
    ...
    internal class BindingsWindowStateController
    {
        ...
        internal void SetColumnWidth(int columnWidth, float width) => CurrentState.SetColumnWidth(columnWidth, width);

        internal BindingsWindowState.ColumnContent GetColumnContent(int columnIndex) => CurrentState.GetColumn(columnIndex).Type;

        internal int GetLODIndexFromColumnIndex(int columnIndex) => CurrentState.GetLODIndexFromColumnIndex(columnIndex);

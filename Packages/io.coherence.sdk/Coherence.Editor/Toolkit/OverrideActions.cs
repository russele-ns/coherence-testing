...
namespace Coherence.Editor
{
    ...
    internal static class OverrideActions
    {
        ...
        /// </param>
        internal static void AddContextMenuItems(GenericMenu menu, SerializedProperty serializedProperty, CoherenceSync sync, bool isInstance, bool isReadOnly)
        {
            if (isReadOnly)
            {
                return;
        ...
        internal static bool RevertOverrides(CoherenceSync sync, SerializedProperty property = null, EditorWindow window = null)
        {
            var propertyModifications = PrefabUtility.GetPropertyModifications(sync);
            if (propertyModifications == null)
            {
            ...
            if (window)
            {
                window.ShowNotification(changed ? new GUIContent("Reverted.\nRequired overrides added.") : new GUIContent("Reverted."));
            }

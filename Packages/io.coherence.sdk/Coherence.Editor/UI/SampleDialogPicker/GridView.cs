...
namespace Coherence.UI
{
    ...
    internal class GridView<T> : VisualElement where T : class, IGridItem
    {
        ...
        public event Action<T, VisualElement, VisualElement> onCreateItem;
        ...
        public GridView()
        {
            ...
            itemsScrollView.viewDataKey = "GridViewScrollView";
            ...
            itemsContainer.viewDataKey = "GridViewContainer";
        ...
        private VisualElement CreateItemElement(T item)
        {
            ...
            onCreateItem?.Invoke(item, icon, label);
            return element;
        }

namespace Coherence.Editor
{
    ...
    internal class CoherenceSyncConfigPostprocessor : AssetPostprocessor
    {
            ...
            string[] movedFromAssetPaths)
        {
            ...
            {
                var guid = AssetDatabase.AssetPathToGUID(deletedAsset, AssetPathToGUIDOptions.IncludeRecentlyDeletedAssets);
                ...
                var syncGuid = AssetDatabase.AssetPathToGUID(syncPath, AssetPathToGUIDOptions.IncludeRecentlyDeletedAssets);
                _ = CoherenceSyncConfigRegistry.Instance.Deregister(syncGuid);
                if (sync && sync.gameObject)
                {

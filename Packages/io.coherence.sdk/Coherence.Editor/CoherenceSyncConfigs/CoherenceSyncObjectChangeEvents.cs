namespace Coherence.Editor
{
    ...
    {
        static CoherenceSyncObjectChangeEvents() => ObjectChangeEvents.changesPublished += ObjectChangeEventsOnChangesPublished;
                        ...
                        case ObjectChangeKind.DestroyGameObjectHierarchy:
                            {
                                ...
                                var parent = EditorUtility.
#if UNITY_6000_3_OR_NEWER
                                    EntityIdToObject
#else
                                    InstanceIDToObject
#endif
                                      (ev.parentInstanceId) as GameObject;
                        ...
                        case ObjectChangeKind.ChangeGameObjectStructureHierarchy:
                            {
                                ...
                                var gameObject = EditorUtility.
#if UNITY_6000_3_OR_NEWER
                                    EntityIdToObject
#else
                                    InstanceIDToObject
#endif
                                        (ev.instanceId) as GameObject;

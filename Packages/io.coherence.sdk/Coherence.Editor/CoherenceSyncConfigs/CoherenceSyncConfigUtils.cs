...
namespace Coherence.Editor
{
    ...
    public static class CoherenceSyncConfigUtils
    {
        ...
        /// <param name="context">
        /// <para>
        /// (Optional) GameObject whose bindings should be included in the results.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </param>
        internal static EntryInfo? GetBindingInfo(CoherenceSync sync, GameObject context = null)
        {
            var (variables, invalidVariables) = CoherenceSyncUtils.GetVariableBindingsCount(sync, context);
            var (methods, invalidMethods) = CoherenceSyncUtils.GetMethodBindingsCount(sync, context);
            var bits = 0;

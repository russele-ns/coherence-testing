...
namespace Coherence.Editor
{
    ...
    internal static class CoherenceHubLayout
    {
        ...
        public static class Styles
        {
            ...
            public static readonly GUIStyle HeaderReminder = new()
            {
                padding =
                {
                    top = 4,
            ...
            public static readonly GUIStyle HeaderReminderText = new(EditorStyles.label)
            {
            };
        ...
        private static void DrawOpenUrlLabel(GUIContent content, string url)
        {
        ...
        public static void DrawLink(GUIContent content, string url) => DrawOpenUrlLabel(content, url);
        public static void DrawLink(GUIContent content, DocumentationKeys key) => DrawLink(content, DocumentationLinks.GetDocsUrl(key));
        public static void DrawLink(string text, string url) => DrawLink(EditorGUIUtility.TrTempContent(text), url);
        public static void DrawLink(string text, DocumentationKeys key) => DrawLink(EditorGUIUtility.TrTempContent(text), DocumentationLinks.GetDocsUrl(key));

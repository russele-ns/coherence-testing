...
namespace Coherence.Editor
{
    ...
    public class LearnModule : HubModule
    {
        ...
        // errors when the coherence Hub window is maximized (because the
        // WelcomeWindow object is created using CreateInstance and never shown).
        private void OnBecameInvisible() => DestroyWelcomeWindowIfExists();

        protected override void OnDisable()
        {
            base.OnDisable();
            DestroyWelcomeWindowIfExists();
        }
        ...
        private void DestroyWelcomeWindowIfExists()
        {
            if (welcomeWindow)
            {

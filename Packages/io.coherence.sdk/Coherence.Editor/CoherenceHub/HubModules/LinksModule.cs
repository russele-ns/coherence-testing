...
namespace Coherence.Editor
{
    ...
    public class LinksModule : HubModule
    {
        ...
        private static List<LinkData> links = new List<LinkData>()
        {
            ...
            new LinkData("Online Dashboard",
                    "The Online Dashboard lets you configure organizations, projects, worlds, rooms, cloud services and game sharing.",
                    new GUIContent("Open Dashboard"),
                    ExternalLinks.OnlineDashboardUrl),

...
namespace Coherence.Editor.Portal
{
    ...
    internal class ReplicationServer
    {
        ...
        public static bool Deploy()
        {
            ...
            var engine_version = RuntimeSettings.Instance.RsVersion;
            ...
            Debug.Log($"Visit the Online Dashboard to see your replication servers' status at: {Endpoints.OnlineDashboard}");

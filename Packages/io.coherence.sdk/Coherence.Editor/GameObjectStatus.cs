namespace Coherence.Editor
{
    ...
    public readonly struct GameObjectStatus
    {
        ...
        /// <summary>
        /// If the GameObjet has a <see cref="CoherenceSync"/> component that is an added override to the prefab
        /// </summary>
        public readonly bool SyncIsAddedOverride;
        ...
        public GameObjectStatus(GameObject gameObject)
        {
            ...
            SyncIsAddedOverride = gameObject.TryGetComponent(out CoherenceSync sync) &&
                                  PrefabUtility.IsAddedComponentOverride(sync);
